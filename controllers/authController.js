...
module.exports.getLoginPage = (req, res) => {
  const pageTitle = "Nodejs Auth App";
...
module.exports.getHomePage = (req, res) => {
  ...
  res.render("home", {
    title: "Homepage | Nodejs Auth App",
    name: req.user.name,
...
module.exports.forgotPassword = async (req, res) => {
  try {
    ...
    const link = `https://nodejs-authentication-system-hf37.onrender.com/resetPassword/${user._id}/${token}`;
    ...
    const mailGenerator = new Mailgen({
      ...
      product: {
        ...
        name: "NodeJs Authentication System",
        link: "https://mailgen.js/",
        copyright:
          "Copyright © 2023 NodeJs Authetication System. All rights reserved.",
      },
    });
    ...
    transporter.sendMail(
      {
        from: '"NodeJs Services"<example@gmail.com>', // sender address
